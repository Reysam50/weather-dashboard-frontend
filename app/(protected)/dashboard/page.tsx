...
const MAP_THEME: "light" | "dark" = "light";
...
const STORAGE_KEY = "main-dashboard";
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    setOrder(loadWidgetOrder(STORAGE_KEY, DEFAULT_WIDGET_ORDER));
  }, []);
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    setOrder((current) => {
      ...
      saveWidgetOrder(STORAGE_KEY, next);
      return next;
    });
  }
